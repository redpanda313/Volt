...
## Swipe any direction = dash (up/air = jump-dash screw; one jump unless a strike refreshes it). Tap a bot = attack-dash in, strike on contact. No joystick / attack button.
